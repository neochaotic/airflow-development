...
# Default test command. Runs unit tests on the live, running environment (faster, for quick checks).
test:
...
help:
	...
	@echo "  test       Run unit tests on the live container (quick check)."
...
.PHONY: build up down restart logs cli clean help lint test test-ci test-integration